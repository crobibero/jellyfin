    ...
    public class JellyfinApplicationFactory : WebApplicationFactory<Startup>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            serviceCollection.AddDbContext<JellyfinDb>(
                options => options
                    .UseSqlite($"Filename={Path.Combine(webHostPathRoot, "jellyfin.db")}")
            ...
            builder.ConfigureWebHostBuilder(appHost, serviceCollection, commandLineOpts, startupConfig, appPaths);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (Directory.Exists(_testPathRoot))
            {
                Directory.Delete(_testPathRoot, true);
            }
        }
    }
}
